...
- [x] **HARDEN-03**: Tokens are redacted in logs by manual `Debug` impls on every token-bearing struct; `cargo deny` blocks a tree of crates that allow unaudited unsafe in the release profile
