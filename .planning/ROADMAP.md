...
**Plans**: 10 plans (revision iteration 2 — waves rebalanced after dependency analysis; 05-10 now wave 4, 05-09 now wave 5)
  ...
  - [ ] 05-09-PLAN.md — Wave 5: Secure Keyboard Entry (Carbon FFI + RAII) + NSTextInputClient IME (5 selectors) + vector-secrets API lock + manual 10-item smoke matrix checkpoint (POLISH-08)
